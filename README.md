...
1. functions are always in a class in java

2. java for-loop is different from python for-loop

3. comments are stated by putting "//" in java while in python, comments comes after "#"

4. needs to declare type in front of a variable in java

5. java use brackets for "if", "else", "for", etc
   while python use indentation and colon

6. semicolon is used to declare the end of the code in java
   while this is not needed in python
